...
public List login(UserVO VO_obj){
	...
	try{
	    ...
	    Query q = session.createQuery("FROM UserVO WHERE userName = '"+VO_obj.getUserName()+"' AND password = '"+VO_obj.getPassword()+"'  ");
	    temp = q.list();
  ...
  public List showAllRegisterUser(){
		...
		List temp = null;
		  try{
			  ...
			  Query q = session.createQuery("FROM UserVO where userType = 1");
  ...
  public List showAllAdmin(){
		...
		List temp = null;
		  try{
			  ...
			  Query q = session.createQuery("FROM UserVO where userType = 3");
  ...
  public List showAllEmployee(){
		...
		List temp = null;
		  try{
			  ...
			  Query q = session.createQuery("FROM UserVO where userType = 2");
