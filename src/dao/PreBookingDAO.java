...
public List getElementByID(PreBookingVO VO_obj){
  ...
  public List showAll(){
		...
		List temp = null;
		  try{
			  ...
			  Query q = session.createQuery("FROM PreBookingVO ");
  ...
  public List showAllByParkingVO(ParkingVO parkingVO){
		...
		List tempData = null;
		  try{
			  ...
			  Query q = session.createQuery("FROM PreBookingVO where parkingID.parkingID ="+parkingVO.getParkingID());
  ...
  public List  getPreBookingByParkingID(ParkingVO VO_obj){
	    ...
	    try{
	    	...
	    	Query q = session.createQuery("FROM PreBookingVO WHERE parkingID.parkingID = "+VO_obj.getParkingID()+" ORDER BY preBookingID DESC ");
