 ...
 <div class="rightpanel">
  ...
  <div class="pageheader">
      ...
      <a href="${pageContext.request.contextPath}/VehicleController" class="btn btn-info"><i class="iconfa-pencil"></i></a> Add Vehicle       
 				...
 				<c:forEach items="${sessionScope.obj_all}" var="record">
                        ...
                        <tr class="gradeX">
                         ...
                         <td>${record.model} - ${record.numberOfVehicle }</td>
                            ...
                            <a href="<%=request.getContextPath() %>/VehicleController?mode=2&id=${record.vehicleID}" class="btn btn-info"><i class="icon-edit"></i></a>
                            <a href="<%=request.getContextPath() %>/VehicleController?mode=4&id=${record.vehicleID}" class="btn btn-info"><i class="iconsweets-trashcan"></i></a>
