  	...
  	function fn(){
		...
		<div class="maincontent">
            ...
            <div class="widgetcontent">
                 <form class="stdform stdform2" action="<%=request.getContextPath() %>/BookingController" method="post">
                    	<input type="hidden" name="mode" value="1">
            
                     <p>
                            <label> paymentInitial </label>
                            
                            <span class="field">
                            <input type="number" name="paymentInitial" placeholder="Inital Payment " class="input-medium"  value="0" />
