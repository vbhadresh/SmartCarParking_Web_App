 ...
 <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><span class="separator"></span>Edit User Information </li>
        </ul>   
  <div class="pageheader">
	...
	<p>
					...
					<p>
                            ...
                            <span class="field">	
                             <c:if test="${record.userType==1}">
                                            <input type="radio" name = "userType" value = "3"/> Administrator 
                                            <input type="radio" name = "userType" value = "2"/> Employee
                                            <input type="radio" name = "userType" checked="checked" value = "1"/> User
                              </c:if>
                                         
                               <c:if test="${record.userType==2}">
                                            <input type="radio" name = "userType" value = "3"/> Administrator 
                                            <input type="radio" name = "userType" checked="checked" value = "2"/> Employee
                                            <input type="radio" name = "userType"  value = "1"/> User
                              </c:if>
                                         
                               <c:if test="${record.userType==3}">
                                            <input type="radio" name = "userType" checked="checked" value = "3"/> Administrator 
                                            <input type="radio" name = "userType" value = "2"/> Employee
                                            <input type="radio" name = "userType"  value = "1"/> User
                              </c:if>
