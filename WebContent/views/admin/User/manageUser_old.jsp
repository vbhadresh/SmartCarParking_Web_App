 				...
 				<c:forEach items="${sessionScope.obj_all}" var="record">
                        ...
                        <tr class="gradeX">
                         ...
                         <td>${record.personID.mobileNumber }</td>
                             <td> <c:if test="${record.attachmentID != null } ">
                        ...
                        <img src="${pageContext.request.contextPath}/backEnd/images/photos/nothumb.png" style="height:86px;width:86px;" alt="" />
                            ...
                            <a href="<%=request.getContextPath() %>/UserController?mode=6&id=${record.userID}" class="btn btn-info"><i class="icon-edit"></i> Allot Parking</a>
                              </c:if>
